...
void SendWSPRManage()
{
  ...
  while(1)
  {
    ...
    if (knobPosition > 0 && knob < 0)
      knobPosition--;
    else if (knob > 0 && (knobPosition <= (nowWsprStep == 0 ? conf.WsprMSGCount : WSPR_BAND_COUNT) * 10 -2))
      knobPosition++;
