...
char i2cRead(uint8_t reg) {   // write reg via i2c
  Wire.beginTransmission(conf.SI5351BX_ADDR);
  Wire.write(reg);
  char auxb=Wire.read();
...
void si5351bx_init() {                  // Call once at power-up, start PLLA
 ...
 // Wire.begin(18,19);
  ...
  //why? TODO : CHECK by KD8CEC  -  initializing the ppl2 as well
